...
class ViewController: UIViewController {
    ...
    @IBAction func btnAdd(_ sender: UIButton) {
        ...
        print(row)
        SCLAlertView().showTitle("Successful!", subTitle: "It added to the list.", timeout: nil, completeText: "Ok", style: .success, colorStyle: 0x22B573, colorTextButton: 0xFFFFFF)}
